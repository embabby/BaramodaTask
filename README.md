...
## Installation
1. Clone the source code. `git clone https://github.com/embabby/BaramodaTask.git`
2. Go to inside the project. `cd BaramodaTask`
...
NOTE: if you saw this message "No application encryption key has been specified" run 'php artisan key:generate'
